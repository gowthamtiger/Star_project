...
spark.sparkContext.addPyFile("s3://gowtham-landzonebucket-batch01/delta-core_2.12-1.2.0.jar")

# Define the configuration file path
config_file_path = "s3://gowtham-rawzonebucket-batch01/app.json"
...
print(filename)
deltatablepath="s3://gowtham-stagingzonebucket-batch01/delta_table/"
